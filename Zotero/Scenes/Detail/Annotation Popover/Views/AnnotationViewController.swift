...
final class AnnotationViewController: UIViewController {
    ...
    private func update(state: PDFReaderState) {
        ...
        // Update header
        self.header.setup(with: annotation, isEditable: (annotation.editability == .editable), showsLock: (annotation.editability != .editable), showDoneButton: false, accessibilityType: .view)
    ...
    private func setupViews() {
        ...
        header.setup(with: annotation, isEditable: (annotation.editability == .editable), showsLock: (annotation.editability != .editable), showDoneButton: false, accessibilityType: .view)
        header.menuTap
