...
internal enum L10n {
  ...
  internal enum Accessibility {
    ...
    internal enum Pdf {
      ...
      internal static let underlineAnnotation = L10n.tr("Localizable", "accessibility.pdf.underline_annotation")
  ...
  internal enum Settings {
    ...
    internal enum CrashAlert {
      /// Copy Report ID
      internal static let copyId = L10n.tr("Localizable", "settings.crash_alert.copy_id")
  ...
  internal enum TagPicker {
    ...
    internal static func confirmDeletion(_ p1: Int) -> String {
      return L10n.tr("Localizable", "tag_picker.confirm_deletion", p1)
    }
    /// Delete Automatic Tags
    internal static let confirmDeletionQuestion = L10n.tr("Localizable", "tag_picker.confirm_deletion_question")
    /// Create Tag “%@”
