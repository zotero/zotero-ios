...
struct ItemAction {
    enum Kind {
        case addToCollection, delete, duplicate, removeFromCollection, restore, trash, createParent
    }
    ...
    var isDestructive: Bool {
        ...
        case .addToCollection, .duplicate, .removeFromCollection, .restore, .createParent: return false
        }
    }
