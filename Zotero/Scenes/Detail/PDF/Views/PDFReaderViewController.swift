    ...
    override func viewDidLoad() {
        ...
        func setupNavigationBar() {
            ...
            if FeatureGates.enabled.contains(.speech), let accessibilityHandler {
                ...
                let accessibilityPrimaryAction = UIAction(title: L10n.Accessibility.showReader, image: Asset.Images.pdfRawReader.image) { [weak self] _ in
                    guard let self else { return }
                ...
                accessibilityButton = UIBarButtonItem(primaryAction: accessibilityPrimaryAction)
