...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal enum Attachments {
      ...
      internal static let listEpub = ImageAsset(name: "Attachments/list-epub")
    ...
    internal enum ItemTypes {
      ...
      internal static let dataset = ImageAsset(name: "Item types/dataset")
      ...
      internal static let epubLinked = ImageAsset(name: "Item types/epub-linked")
      internal static let epub = ImageAsset(name: "Item types/epub")
      ...
      internal static let standard = ImageAsset(name: "Item types/standard")
